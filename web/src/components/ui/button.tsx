...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-none border border-transparent bg-clip-padding font-mono text-xs font-semibold tracking-[0.1em] uppercase whitespace-nowrap transition-colors outline-none select-none focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-2 aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        newspaper:
          "h-auto bg-transparent px-0 font-sans text-sm font-semibold tracking-[0.04em] text-muted-foreground hover:text-foreground focus-visible:ring-0",
        newspaperActive:
        ...
        marketTrade:
          "min-w-36 bg-foreground font-sans text-xs text-background hover:bg-destructive",
        destructive:
